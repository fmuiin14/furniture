...
<header class="absolute w-full z-50 px-4">
    <div class="container mx-auto py-5">
        <div class="flex flex-stretch items-center" style="background: none;">
            <div class=" items-center flex">
                <a href="{{route('index')}}">
                    <img src="/fe/images/content/logo.png"
                        alt="Furniture | Lengkapi rumah anda dengan Furniture berkualitas"
            ...
            <div class="w-auto">
                <ul class="items-center flex" style="background: none;">
                    ...
                    <li class="ml-6">
                        <a id="header-cart"
                            ...
                            style="background: none;" href="cart.html">
